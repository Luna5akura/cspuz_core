...
puzzle_list!(puzz_link,
    ...
    (japanese_sums_with_zeroes, ["japanesesumswithzeroes"], "Japanese Sums with Zeroes", "数字和（0あり）"),
    (kakuro, ["kakuro", "consecutivekakuro"], "Kakuro", "カックロ"),
    (japanese_arrows, ["japanese_arrows"], "Japanese Arrows", "ジャパニーズアローズ"),
    (fourwinds, ["fourwinds"], "Four Winds", "フォーウィンズ"),
    (fourwindswithparks, ["fourwindswithparks"], "Four Winds with Parks", "四風"),
    (abcbox, ["abcbox"], "ABC-Box", "ABCボックス"),
    ...
    (lits, ["lits"], "LITS", "LITS"),
    (lostspeech, ["lostspeech"], "Lost Speech", "Lost Speech"),
    ...
    (magic_summer, ["magic-summer", "magicsummer"], "Magic Summer", "Magic Summer"),
    ...
    (neighbor, ["neighbors", "neighbor"], "Neighbors", "Neighbors"),
    (sky_neighbor, ["skyneighbors", "sky-neighbors", "sky-neighbor"], "Sky Neighbors", "Sky Neighbors"),
    ...
    (walkwalk, ["walkwalk"], "Walk Walk", "ウォークウォーク"),
