...
impl ItemKind {
    pub fn to_json(&self) -> String {
        match self {
            ...
            &ItemKind::ArrowUpLeft => String::from("\"arrowUpLeft\""),
            &ItemKind::ArrowUpRight => String::from("\"arrowUpRight\""),
            &ItemKind::ArrowDownLeft => String::from("\"arrowDownLeft\""),
            &ItemKind::ArrowDownRight => String::from("\"arrowDownRight\""),
